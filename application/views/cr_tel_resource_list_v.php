        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="width:9%;">
                    ...
                    <a class="confirm_delete" href="<?php echo site_url('cr/del/' . $v->customer_id.'?fromuri=cr_tel/resource'); ?>"><img class="operator" src="theme/images/icon_del.gif" alt="删除" title="删除"></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
