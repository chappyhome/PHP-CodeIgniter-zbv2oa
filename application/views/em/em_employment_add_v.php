...
<div class="pageContent">
    <form method="post" action="<?php echo site_url('em/add/submit'); ?>" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
            ...
            <dl>
                ...
                <dd>
                    ...
                    <input class="required textInput" name="department_name" readonly="readonly" type="text" suggestFields="department_name" 
                           suggestUrl="<?php echo site_url('em/add/department'); ?>" lookupGroup=""/>
                </dd>
            </dl>
            <dl>
                <dt>职位：</dt>
