				...
				<tr>
					<td>
						<table class="list_table2" width="100%">
							...
							<tr>
							  <th>网站名称</th>
							  <td><b class="f14 red3"><?php echo "ZBV2OA"; ?></b></td></tr>
							<tr>
							  <th>平台版本</th>
							  <td><b><?php echo SYS_VERSION; ?>(CI:<?php echo CI_VERSION; ?>)</b></td></tr>
							<tr>
							  <th>脚本语言</th>
		  ...
		  <tbody>
		    <tr>
		      <td><table class="list_table2" width="100%">
		        ...
		        <tr>
		          <th>当前帐号</th>
		          <td colspan="2"><?php echo $this->_admin->user_name; ?></td>
	            </tr>
		        <tr>
		          <th>所属用户组</th>
		          <td><b class="f14 red3"><?php echo $this->_admin->role_name; ?></b></td>
	            </tr>
		        <tr>
		          <th>登录IP</th>
		        ...
		        <tr>
		          <th>&nbsp;</th>
		          <td><a href="<?php echo site_url('system/password'); ?>">修改密码</a></td>
	            </tr>
		        </table></td>
	        </tr>
	      </tbody>
